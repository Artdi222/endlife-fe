...
const navGroups: NavGroup[] = [
  {
    label: "User Master",
    icon: "◉",
    items: [{ label: "Users", href: "", icon: "→" }],
  },
  {
    label: "Daily Master",
    icon: "◈",
    items: [
      { label: "Categories", href: "0", icon: "→" },
      { label: "Groups", href: "46", icon: "→" },
      { label: "Sub Groups", href: "34", icon: "→" },
      { label: "Tasks", href: "7", icon: "→" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Weapons", href: "1", icon: "→" },
      { label: "Gears", href: "2", icon: "→" },
      { label: "Items", href: "3", icon: "→" },
    ],
  },
];
