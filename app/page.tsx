          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center gap-3">
                <span className="text-4xl text-yellow-300 leading-none">⬡</span>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                A simple daily checklist for Arknights: Endfield players to
              ...
              >
                <Link href="/sign-up">
                  <motion.button
                    whileHover={{
                      scale: 1.06,
                      boxShadow: "0 0 35px rgba(253,224,71,0.4)",
                    }}
                    whileTap={{ scale: 0.96 }}
